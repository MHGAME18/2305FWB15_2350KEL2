...
<div class="panel panel-primary">
	...
	<br><br>
	<div class="form-group">
		<label class="col-sm-2 control-label" id="id_kategori">Jenis</label>
		<div class="col-sm-10">
			{!! Form::select('kategori', $kategori->lists('jenis', 'id'),null,['class'=>'form-control','id'=>'id_kategori', 'placeholder'=>"Pilih Jenis"]) !!}
		</div>
	</div>
	<br>
	<br>
